...
parser.add_option("-m", "--main_path", dest="main_path", help="main folder to record the training result")
parser.add_option("-p", "--test_path", dest="test_path", help="Path to test data.")
...
parser.add_option("-i", "--test_images", dest="test_images", help="path to store test images",
                  default="./data/test")
parser.add_option("--record_path", dest="record_path",
                  help="csv file to record training data",
                  default="./Model/record.csv")
...
base_path = options.main_path
test_path = options.test_path
test_base_path = options.test_images
...
for idx, img_name in enumerate(sorted(os.listdir(test_base_path))):
